        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
            ...
            <p className="text-gray-400 max-w-md">
              Arama kriterlerinize uygun mağaza bulunamadı. Lütfen farklı
              anahtar kelimelerle tekrar deneyin veya tüm mağazaları görüntüleyin.
            </p>
            <div className="pt-4">
              <button
                onClick={() => {
                  ...
                  <div className="flex items-center text-sm text-gray-400 mb-3 gap-1">
                    ...
                    <span>
                      {dealer.district || dealer.city
                        ? `${dealer.district ? dealer.district + ", " : ""}${dealer.city || ""}`
                        : "Konum Belirtilmemiş"}
                    </span>
